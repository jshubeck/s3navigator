...
// Version: 3.15.7.43
// Dated: 22-AUG-2021
// Author: John Shubeck (jrshubeck@gmail.com)
// Source: A fork of https://github.com/rufuspollock/s3-bucket-listing 
//
...
function prepareTable(info) {
  ...
  var cols = [45, 30, 15];
  var content = [];
  content.push(padRight('DATE LAST MODIFIED', cols[1]) + '  ' +
               padRight('SIZE', cols[2]) + 'OBJECT NAME \n');
